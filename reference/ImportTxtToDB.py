...
df1={}
df1=pd.read_csv(r'C:\Users\Administrator\Desktop\NA_US-20210101-20210131-207191018690.txt',sep='\t',encoding="utf-8")

#print(df1.tail())
#rint(df1.count())
#print(df1.sum())
#print(df1.sum('item-price'))

df1.to_excel(r'C:\Users\Administrator\Desktop\NA_US-20210101-20210131-207191018690.xlsx',sheet_name='df1',startrow=to_excel_row)
df_rows = df1.shape[0]
#print (df_rows)
df1.to_excel(r'C:\Users\Administrator\Desktop\NA_US-20210101-20210131-207191018690.xlsx',sheet_name='df1',startrow=df_rows)
...
'''
    读取csv函数
    args：csv_file（csv文件，目录在py文件同目录）
    returns：book
'''
...
if __name__ == '__main__':
    store_to('Linkchance', 'AMA_AllPayments', 'NA_US-20210101-20210131-207191018690')
